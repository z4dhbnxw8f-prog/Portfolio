...
export const projects: Project[] = [
  {
    ...
    status: 'Live',
    image: '/projects/penee.png',
    imageAlt: 'Penee personal finance application secure login screen',
    summary: 'A personal finance application for managing accounts, transactions, budgets and multiple currencies with careful handling of financial history.',
    ...
    architecture: 'A React interface runs in Next.js. Server Actions and API route handlers coordinate application logic, Prisma maps the data layer, PostgreSQL stores records, and session-based authentication protects user data.',
    ...
    result: 'A deployed full-stack application that demonstrates the complete flow from responsive UI to financial business rules and data integrity.',
    links: [{ label: 'Live demo', url: 'https://xpense-trvcker.vercel.app' }],
  },
  {
    slug: 'itemvault',
    name: 'ItemVault',
  ...
  },
  {
    ...
    kicker: 'Business-focused application',
    type: 'Real-World Business Web Application',
    status: 'Live',
    image: '/projects/cosmic-styles.png',
